...
local function resume_server_formspec(dialogdata)
	...
	if th and th.button_secondary and th.button_primary then
		...
		table.insert(fs, th.button_primary(4.25, btn_y, 3.45, 0.85, "btn_resume_connect", fgettext("▶ CONNECT"), nil, btn_font))
	else
		table.insert(fs, string.format("style[btn_resume_cancel;border=true;bgcolor=#334155;textcolor=#f1f5f9;font=bold;%s]", btn_font))
		table.insert(fs, string.format("style[btn_resume_cancel:hovered;border=true;bgcolor=#475569;textcolor=#ffffff;font=bold;%s]", btn_font))
		table.insert(fs, string.format("style[btn_resume_cancel:focused;border=true;bordercolor=#38bdf8;bgcolor=#334155;textcolor=#ffffff;font=bold;%s]", btn_font))
		table.insert(fs, string.format("style[btn_resume_cancel:focused+hovered;border=true;bordercolor=#38bdf8;bgcolor=#475569;textcolor=#ffffff;font=bold;%s]", btn_font))
		table.insert(fs, string.format("style[btn_resume_cancel:pressed;border=true;bgcolor=#1e293b;textcolor=%s;font=bold;%s]", c.text_muted, btn_font))
		table.insert(fs, string.format("button[0.5,%f;3.45,0.85;btn_resume_cancel;%s]",
			btn_y, core.formspec_escape(fgettext("Cancel"))))

		table.insert(fs, string.format("style[btn_resume_connect;border=true;bgcolor=%s;textcolor=%s;font=bold;%s]",
			c.btn_primary_bg, c.text_primary, btn_font))
		table.insert(fs, string.format("style[btn_resume_connect:hovered;border=true;bgcolor=%s;textcolor=%s;font=bold;%s]",
			c.btn_primary_hover, c.text_primary, btn_font))
		table.insert(fs, string.format("style[btn_resume_connect:focused;border=true;bordercolor=%s;bgcolor=%s;textcolor=%s;font=bold;%s]",
			c.btn_primary_focus, c.btn_primary_bg, c.text_primary, btn_font))
		table.insert(fs, string.format("style[btn_resume_connect:focused+hovered;border=true;bordercolor=%s;bgcolor=%s;textcolor=%s;font=bold;%s]",
			c.btn_primary_focus, c.btn_primary_hover, c.text_primary, btn_font))
		table.insert(fs, string.format("style[btn_resume_connect:pressed;border=true;bgcolor=%s;textcolor=%s;font=bold;%s]",
