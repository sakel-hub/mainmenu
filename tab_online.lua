...
local function is_selected_fav(_server)
...
local function get_formspec(_tabview, _name, tabdata)
...
local function main_button_handler(tabview, fields, _name, tabdata)
