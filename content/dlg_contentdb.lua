...
--- @param initial_search string | nil
--- Initial search query to pre-fill in ContentDB explorer.
function create_contentdb_dlg(type, install_spec, initial_search)
	search_string = initial_search or ""
	cur_page = 1
	filter_type = type
